...
{
    public partial class frm_GTVT_BAOCAOSLBN_THEODOITUONG : Form
    {
        public frm_GTVT_BAOCAOSLBN_THEODOITUONG()
        {
            InitializeComponent();
        ...
        private void cmdINPHIEU_Click(object sender, EventArgs e)
        {
            try
            {
                dtPatient = null;//SPs.GtvtBaocaoSluongBnhanTheodoituong(dtpFromDate.Value.Date, dtpToDate.Value.Date).GetDataSet().Tables[0];
        ...
        private void frm_XD_BAOCAOSLBN_THEODOITUONG_Load(object sender, EventArgs e)
        {
