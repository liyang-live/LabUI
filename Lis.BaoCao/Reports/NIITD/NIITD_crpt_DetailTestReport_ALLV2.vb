...
Public Class NIITD_crpt_DetailTestReport_ALLV2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "NIITD_crpt_DetailTestReport_ALLV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjBussiness.NIITD_crpt_DetailTestReport_ALLV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TitleReport() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedNIITD_crpt_DetailTestReport_ALLV2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NIITD_crpt_DetailTestReport_ALLV2 = New NIITD_crpt_DetailTestReport_ALLV2()
        rpt.Site = Me.Site
        Return rpt
    End Function
