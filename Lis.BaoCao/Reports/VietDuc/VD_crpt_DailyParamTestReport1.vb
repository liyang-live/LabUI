...
Public Class VD_crpt_DailyParamTestReport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjBussiness.VD_crpt_DailyParamTestReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVD_crpt_DailyParamTestReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VD_crpt_DailyParamTestReport1 = New VD_crpt_DailyParamTestReport1()
        rpt.Site = Me.Site
        Return rpt
    End Function
