...
Public Class crptPrintBarcode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjBussiness.crptPrintBarcode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptPrintBarcode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptPrintBarcode = New crptPrintBarcode()
        rpt.Site = Me.Site
        Return rpt
    End Function
