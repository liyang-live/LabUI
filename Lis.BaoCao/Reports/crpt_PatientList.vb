...
Public Class crpt_PatientList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjBussiness.crpt_PatientList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpt_PatientList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpt_PatientList = New crpt_PatientList()
        rpt.Site = Me.Site
        Return rpt
    End Function
