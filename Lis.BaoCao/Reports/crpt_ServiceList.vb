...
Public Class crpt_ServiceList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjBussiness.crpt_ServiceList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpt_ServiceList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpt_ServiceList = New crpt_ServiceList()
        rpt.Site = Me.Site
        Return rpt
    End Function
