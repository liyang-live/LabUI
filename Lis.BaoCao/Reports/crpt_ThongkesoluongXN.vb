...
Public Class crpt_ThongkesoluongXN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjBussiness.crpt_ThongkesoluongXN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpt_ThongkesoluongXN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpt_ThongkesoluongXN = New crpt_ThongkesoluongXN()
        rpt.Site = Me.Site
        Return rpt
    End Function
