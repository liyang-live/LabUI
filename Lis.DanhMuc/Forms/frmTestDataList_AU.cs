...
{
    public partial class frmTestDataList_AU : Form
    {
        public DataRow drData;
        public DataTable dtTestDataList,dtTestType;
        public action vAction;

        public frmTestDataList_AU()
        {
            InitializeComponent();
        }
        ...
        {
            txtID.Enabled = false;
            txtID.Text = Utility.sDbnull(drData[LStandardTest.Columns.TestDataId], "NONE");
            txtName.Text = Utility.sDbnull(drData[LStandardTest.Columns.DataName], "NONE");
            txtSequence.Value = Utility.Int32Dbnull(drData[LStandardTest.Columns.DataSequence], 0);
            cboTestType.SelectedValue = Utility.Int32Dbnull(drData[LStandardTest.Columns.TestTypeId] ,- 1);
            txtMeasureUnit.Text = Utility.sDbnull(drData[LStandardTest.Columns.MeasureUnit]);
            txtNormalLevel.Text = Utility.sDbnull(drData[LStandardTest.Columns.NormalLevel]);
            txtNormalLevelW.Text = Utility.sDbnull(drData[LStandardTest.Columns.NormalLevelW]);
            txtSequence.Text = Utility.sDbnull(drData[LStandardTest.Columns.DataSequence]);
            txtDataPoint.Value = Utility.ByteDbnull(drData[LStandardTest.Columns.DataPoint]);
            ckbDataView.Checked = Utility.sDbnull(drData[LStandardTest.Columns.DataView],"false") == "True" ;
            ckbDataPrint.Checked = Utility.sDbnull(drData[LStandardTest.Columns.DataPrint], "false") == "True";
            txtDesc.Text = Utility.sDbnull(drData[LStandardTest.Columns.Description]);
        }
