...
{
    public partial class FrmDangKyTraCuu : Form
    {
        /// <summary>
        ...
        private void cmd_InPhieu_ChiDinh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frm.Patient_ID = Utility.Int32Dbnull(grdPatients.GetValue("Patient_ID"), -1);
                frm.ShowDialog();
            }
            catch (Exception ex)
            {
        ...
        private void cmd_InPhieu_XetNghiem_TongHop_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               IsQuick = false;
                ...
                {
                    INPHIEU_XETNGHIEM(true, "IN PHIẾU KẾT QUẢ XÉT NGHIỆM", dtpDatePrint.Value);
                }
            }
            catch (Exception ex)
            {
