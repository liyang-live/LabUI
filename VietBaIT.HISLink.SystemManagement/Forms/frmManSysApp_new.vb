...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmManSysApp_new))
        Me.imgAdminnistration = New System.Windows.Forms.ImageList()
        Me.imlQuanTri = New System.Windows.Forms.ImageList()
        ...
        Me.grdFunction.Location = New System.Drawing.Point(552, 119)
        Me.grdFunction.Name = "grdFunction"
        Me.grdFunction.RowHeaderWidth = 5
        Me.grdFunction.Size = New System.Drawing.Size(100, 108)
...
#Region "Các hàm khởi tạo dữ liệu khi chương trình bắt đầu chạy"
    ...
    Private Sub Initialize(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            AppLogger.NLogAction.Log.Trace("tvwAdminSystem_Click...")
            tvwAdminSystem_Click(sender, e)
            AppLogger.NLogAction.Log.Trace("BuildMainMenu...")
        ...
        Catch ex As Exception
            AppLogger.NLogAction.Log.Trace("Initialize.Exception..." + ex.Message)
        End Try
    End Sub
...
#Region "Các sự kiện của Form"
    ...
    Private Sub QTHT_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AppLogger.NLogAction.Log.Trace("EnvisibleAllControls...")
        ...
        End If
        AppLogger.NLogAction.Log.Trace("Call LoginSystem...")
    ...
    Private Function LoginSystem(ByVal sender As System.Object, ByVal e As System.EventArgs) As Boolean
        ...
        If VNS.Libs.globalVariables.SqlConn Is Nothing Then
            Return False
        End If
        AppLogger.NLogAction.Log.Trace("CheckTable Sys_ManagementUnit...")
        If Not clsUtil.CheckTable("Sys_ManagementUnit") Then
            Dim sv_oForm As New Frm_AddBranch
            sv_oForm.mv_bInsert = True
            sv_oForm.ShowDialog()
        End If
        AppLogger.NLogAction.Log.Trace("CheckTable Sys_ManagementUnit-->Branch...")
        If Not clsUtil.CheckTable("Sys_ManagementUnit", "PK_sBranchID=N'" & gv_sBranchID & "'") Then
            ...
            Return False
        End If
        AppLogger.NLogAction.Log.Trace("CheckTable Sys_ADMINISTRATOR-->Thêm quản trị hệ thống...")
        If Not clsUtil.CheckTable("Sys_ADMINISTRATOR", "FP_sBranchID=N'" & gv_sBranchID & "'") Then
            ...
            Try
                ...
                End If
            Catch ex As Exception
                AppLogger.NLogAction.Log.Trace("Exception Of CheckTable..." + ex.Message)
            End Try
        End If
        Dim sv_oLoginForm As New frmLogin
        AppLogger.NLogAction.Log.Trace("sv_oLoginForm.ShowDialog()...")
        ...
        Try
            If gv_bLoginSuccess Then
                ...
                AppLogger.NLogAction.Log.Trace("Prepare Initialize...")
                Initialize(sender, e)
                Application.DoEvents()
            ...
            Return True
        Catch ex As Exception
            AppLogger.NLogAction.Log.Trace("LoginSystem.Exception-->" + ex.Message)
            mv_oFlashForm.thre.Abort()
            mv_oFlashForm.Close()
        End Try
    End Function
...
#Region "Các hàm và sự kiện khác"
    ...
    Private Sub MenuItem2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        End Try
    End Sub
    Private Sub lblLoading_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub picGetRole_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGetRight.Click
        ...
        Try
            ...
            Select Case mv_intTabIndex
                Case 0 'Phân quyền theo Role
                    Dim temp As Boolean = gv_bCanDblClickToGetRolesForUser
                    gv_bCanDblClickToGetRolesForUser = True
                    tvwRoleForUser_DoubleClick(sender, e)
                    gv_bCanDblClickToGetRolesForUser = temp
...
#Region "Các hàm phục vụ cho việc cập nhật biểu tượng, ảnh nền cho mỗi phân hệ"
    Private Sub picSubSystem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim sv_iRoleID As Integer
        Dim sv_clsRole As New clsRole
        Dim fileDiag As New OpenFileDialog
        Try
