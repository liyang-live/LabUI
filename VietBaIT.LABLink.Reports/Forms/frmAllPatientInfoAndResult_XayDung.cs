    ...
    public partial class frmAllPatientInfoAndResult_XayDung : Form
    {
        ...
        private void frmArchiverReport_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                DataBinding.BindDataCombox(cboTestType, dtTestType, TTestTypeList.Columns.TestTypeId, TTestTypeList.Columns.TestTypeName);
                ...
                DataBinding.BindDataCombox(cboDevices, dtDevices, DDeviceList.Columns.DeviceId, DDeviceList.Columns.DeviceName, "---Chọn tất cả---");
