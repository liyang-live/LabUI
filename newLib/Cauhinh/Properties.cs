   ...
   DisplayName("OpenOnlyCurrent")]
    ...
    public class NoitruProperties
    {
        ...
        public NoitruProperties()
        {
            ...
            ChonBacsi = true;
            ViewOnClick = false;
            HienthiPhieudieutritheokhoa = false;
            Hienthitatcaphieudieutrikhisaochep = true;
            Chophepchonkhoanoitrudieutri = false;
            Songayhienthi = -1;
            TurnOn = true;
        }
        [Browsable(true), ReadOnly(false), Category("Cảnh báo tạm ứng"),
   Description("true=Bật cảnh báo tạm ứng tại chức năng lập phiếu điều trị"),
   DisplayName("Bật cảnh báo tạm ứng")]
        public bool TurnOn { get; set; }


        [Browsable(true), ReadOnly(false), Category("Cấu hình Phiếu điều trị"),
Description("Cho phép chọn khoa nội trú khi lập phiếu điều trị. Nếu không sẽ chỉ hiển thị đúng khoa của Bệnh nhân đang nằm(nếu đã phân buồng giường) hoặc khoa cấu hình theo máy(Nếu chưa phân buồng giường)"),
DisplayName("Cho phép chọn khoa nội trú khi lập phiếu điều trị")]
        public bool Chophepchonkhoanoitrudieutri { get; set; }
...
DisplayName("Số ngày hiển thị phiếu điều trị")]
 ...
 DisplayName("Hiển thị tất cả phiếu điều trị khi sao chép")]
   ...
   DisplayName("Hiển thị thông tin phiếu điều trị ngay sau khi chọn")]
        ...
        [Browsable(true), ReadOnly(false), Category("Cấu hình Phiếu điều trị"),
    Description("true=Bắt nhập bác sĩ điều trị khi lập phiếu điều trị"),
    DisplayName("Bắt nhập bác sĩ điều trị")]
        public bool ChonBacsi { get; set; }

        [Browsable(true), ReadOnly(false), Category("Cấu hình Phiếu điều trị"),
   Description("true=Hiển thị phiếu theo khoa. false= Hiển thị cả phiếu điều trị của khoa khác"),
   DisplayName("Hiển thị phiếu theo khoa")]
        public bool HienthiPhieudieutritheokhoa { get; set; }
 ...
 DisplayName("Thoát khỏi chức năng ngay sau khi lưu")]
   ...
   Description("Tự động chuyển thanh toán khi in phôi"),
    ...
    public class MayInProperties
    {
        ...
        CoGiayInTomtatDieutriNgoaitru = Papersize.A4;
            ...
            mauinhoadon = "mau1";
            mauinbienlai = "mau1";
            TieudeBienlaiBHYT = "BIÊN LAI THU TIỀN ĐỐI TƯỢNG BHYT";
            TieudeBienlaiDV = "BIÊN LAI THU TIỀN ĐỐI TƯỢNG DỊCH VỤ";
            Tieudehoadon = "HÓA ĐƠN";
            TieudephoiBHYT = "BẢNG KÊ CHI PHÍ KCB NGOẠI TRÚ";
      ...
      DisplayName("Tự dộng in sau khi thanh toán")]
        ...
        [Browsable(true), ReadOnly(false), Category("Cấu hình tính năng in hóa đơn"),
        Description("0=Không in;1=Chỉ in hóa đơn;2=Chỉ in biên lai;3=In cả 2"),
        DisplayName("Khi thanh toán thì in ngay")]
        public int Kieuinhoadon { get; set; }
        ...
        [Browsable(true), ReadOnly(false), Category("Cấu hình tính năng in hóa đơn"),
       Description("Tiêu đề biên lai BHYT"),
       DisplayName("Tiêu đề biên lai BHYT")]
        public string TieudeBienlaiBHYT { get; set; }

        [Browsable(true), ReadOnly(false), Category("Cấu hình tính năng in hóa đơn"),
       Description("Tiêu đề hóa đơn"),
       DisplayName("Tiêu đề hóa đơn")]
        public string Tieudehoadon { get; set; }

        [Browsable(true), ReadOnly(false), Category("Cấu hình tính năng in hóa đơn"),
       Description("Tiêu đề phôi BHYT"),
       DisplayName("Tiêu đề phôi BHYT")]
        public string TieudephoiBHYT { get; set; }



        [Browsable(true), ReadOnly(false), Category("Cấu hình tính năng in hóa đơn"),
       Description("Tiêu đề biên lai dịch vụ"),
       DisplayName("Tiêu đề biên lai dịch vụ")]
        public string TieudeBienlaiDV { get; set; }
    ...
    public class NhapkhoProperties
    {
       ...
       DisplayName("Cho phép nhập giá bán")]
        ...
        [Browsable(true), ReadOnly(false), Category("Cấu Hình nhập kho "),
         Description("Kiểm tra tổng tiền"),
         DisplayName("Kiểm tra tổng tiền")]
        public bool kiemtratongtien { get; set; }
    ...
    public class ChuyenkhoProperties
    {
      ...
      DisplayName("Hiển thị chọn ngày xác nhận")]
        ...
        [Browsable(true), ReadOnly(false), Category("Cấu Hình chuyển nội bộ "),
        Description("true=In 2 liên, false= in 1 liên"),
        DisplayName("In 2 liên")]
        public bool In2lien { get; set; }
    ...
    public class KCBProperties
    {
     ...
     DisplayName("Kiểu hiển thị nút")]
       ...
       DisplayName("Xóa thông tin BHYT")]
        ...
        [Browsable(true), ReadOnly(false), Category("Cấu hình tính năng tiếp đón Bệnh nhân"),
     Description("Ẩn đăng ký chỉ định CLS"),
     DisplayName("Ẩn đăng ký chỉ định CLS")]
        public bool Anchidinh { get; set; }

        [Browsable(true), ReadOnly(false), Category("Cấu hình tính năng tiếp đón Bệnh nhân"),
    Description("Độ rộng chỉ định CLS"),
   ...
   DisplayName("Hiển thị cấu hình xuất thuốc khi kê đơn")]
    ...
    public class ThamKhamProperties
    {
        public ThamKhamProperties()
        {
            ...
            BatnhapNgaydieutriBHYT = true;
            BatnhapNgaydieutriDV = false;
       ...
       DisplayName("ID kho vừa kê")]
        ...
        [Browsable(true), ReadOnly(false), Category("Cấu hình tính năng thăm khám"),
        Description("Bắt nhập số ngày điều trị ngoại trú với bệnh nhân BHYT"),
        DisplayName("Bắt nhập số ngày điều trị ngoại trú với bệnh nhân BHYT")]
        public bool BatnhapNgaydieutriBHYT { get; set; }
        [Browsable(true), ReadOnly(false), Category("Cấu hình tính năng thăm khám"),
       Description("Bắt nhập số ngày điều trị ngoại trú với bệnh nhân dịch vụ"),
       DisplayName("Bắt nhập số ngày điều trị ngoại trú với bệnh nhân dịch vụ")]
        public bool BatnhapNgaydieutriDV { get; set; }
     ...
     DisplayName("Hỏi trước khi xóa thuốc")]
        ...
        [Browsable(true), ReadOnly(false), Category("Cấu hình tính năng thăm khám"),
       Description("Tự động load sổ tay bác sĩ theo thuốc được chọn nếu BS lưu sổ tay"),
       DisplayName("Tự động load sổ tay bác sĩ")]
        public bool AutoLoadMemo { get; set; }
  ...
  DisplayName("Cho phép in phiếu ĐCT trước khi in phôi BHYT")]
        ...
        [Browsable(true), ReadOnly(false), Category("Cấu hình tính năng hóa đơn đỏ"),
    Description("Nếu có sử dụng hóa đơn đỏ thì đặt=true. Nếu không sử dụng hóa đơn đỏ thì đặt=false"),
    DisplayName("Sử dụng hóa đơn đỏ")]
        public bool Sudunghoadondo { get; set; }
 ...
 DisplayName("Chuyển Tab sau khi chọn bệnh nhân")]
  ...
  DisplayName("Tự động tìm kiếm ngay khi vào chức năng thanh toán")]
        public bool SearhWhenStart { get; set; }
...
DisplayName("Ẩn thanh trạng thái StatusBar")]
     ...
     DisplayName("Cách thức chiết khấu")]
      ...
      DisplayName("Ẩn tab đã thanh toán")]
        ...
        [Browsable(true), ReadOnly(false), Category("Cấu hình tính năng hủy thanh toán"),
        Description("Nhập lý do trước khi hủy thanh toán"),
        DisplayName("Nhập lý do trước khi hủy thanh toán")]
        public bool Nhaplydohuythanhtoan { get; set; }
