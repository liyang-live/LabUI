...
namespace VNS.Libs
{
    public class globalVariables
    {
       ...
       // public static int gv_intPhantramLuongcoban = 15;
        ...
        public static string IpMacAddress = "";
        ...
        public static string gv_strMaThuTuIn_BHYT = "STT_INPHOIBHYT";
        public static string gv_strMaThuTuIn_DV = "STT_IN_DICHVU";
       ...
       // public static DmucKhoaphong objKhoaphong = null;
        ...
        ///<summary>
        ///</summary>
        public static string FORMTITLE = "LIS - HỆ THỐNG QUẢN LÝ THÔNG TIN KHOA XÉT NGHIỆM";
