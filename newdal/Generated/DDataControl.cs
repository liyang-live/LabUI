...
namespace LIS.DAL
{
	...
	/// </summary>
    [Serializable]
	public partial class DDataControlCollection : ActiveList<DDataControl, DDataControlCollection>
	{	   
		public DDataControlCollection() {}
	...
	/// </summary>
	[Serializable]
	public partial class DDataControl : ActiveRecord<DDataControl>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("D_DATA_CONTROL", TableType.Table, DataService.GetInstance("ORM"));
				...
				TableSchema.TableColumn colvarSCondition = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarSFormula = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarForceRun = new TableSchema.TableColumn(schema);
		...
		/// </summary>
		public static void Insert(decimal varDeviceId,int varDataTypeId,int? varDataSequence,bool? varControlType,string varDataName,string varAliasName,string varMeasureUnit,short varDataPoint,string varNormalLevel,string varNormalLevelW,bool? varDataView,bool? varDataPrint,string varDataType,string varDescription,string varTestDataId,string varSCondition,string varSFormula,short? varForceRun)
		{
