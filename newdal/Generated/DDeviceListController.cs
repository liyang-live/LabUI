...
namespace LIS.DAL
{
    ...
    public partial class DDeviceListController
    {
        // Preload our schema..
        DDeviceList thisSchemaLoad = new DDeviceList();
	    ...
	    public void Update(decimal DeviceId,int? DeviceType,int? TestTypeId,string DeviceName,int? PortId,short? ManufactureId,bool? DeviceControl,bool? Valid,string Description,string BarcodeType,short SendType)
	    {
		    DDeviceList item = new DDeviceList();
	        item.MarkOld();
	        item.IsLoaded = true;
