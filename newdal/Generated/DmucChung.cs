...
namespace LIS.DAL
{
	...
	public partial class DmucChung : ActiveRecord<DmucChung>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varMa,string varLoai,string varTen,int varSttHthi,int varTrangThai,string varVietTat,string varMotaThem,string varNguoiTao,DateTime? varNgayTao,string varNguoiSua,DateTime? varNgaySua)
		{
		...
		/// </summary>
		public static void Update(string varMa,string varLoai,string varTen,int varSttHthi,int varTrangThai,string varVietTat,string varMotaThem,string varNguoiTao,DateTime? varNgayTao,string varNguoiSua,DateTime? varNgaySua)
		{
			DmucChung item = new DmucChung();
