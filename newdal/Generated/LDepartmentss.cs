...
{
	/// <summary>
	/// Strongly-typed collection for the LDepartmentss class.
	/// </summary>
    [Serializable]
	public partial class LDepartmentssCollection : ActiveList<LDepartmentss, LDepartmentssCollection>
	{	   
		public LDepartmentssCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>LDepartmentssCollection</returns>
		public LDepartmentssCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                LDepartmentss o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the L_Departmentss table.
	/// </summary>
	[Serializable]
	public partial class LDepartmentss : ActiveRecord<LDepartmentss>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public LDepartmentss()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public LDepartmentss(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public LDepartmentss(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public LDepartmentss(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("L_Departmentss", TableType.Table, DataService.GetInstance("ORM"));
				...
				DataService.Providers["ORM"].AddSchema("L_Departmentss",schema);
			}
		}
		#endregion
