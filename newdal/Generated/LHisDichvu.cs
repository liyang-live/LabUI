	...
	public partial class LHisDichvu : ActiveRecord<LHisDichvu>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarIdNhom.DataType = DbType.String;
				colvarIdNhom.MaxLength = 500;
		...
		{
			get { return GetColumnValue<string>(Columns.IdNhom); }
		...
		/// </summary>
		public static void Insert(string varIdDichVu,string varTenDv,string varIdNhom,int? varLaTriSo)
		{
		...
		/// </summary>
		public static void Update(int varId,string varIdDichVu,string varTenDv,string varIdNhom,int? varLaTriSo)
		{
			LHisDichvu item = new LHisDichvu();
