...
namespace LIS.DAL
{
	...
	/// </summary>
    [Serializable]
	public partial class LStandardTestCollection : ActiveList<LStandardTest, LStandardTestCollection>
	{	   
		public LStandardTestCollection() {}
	...
	/// </summary>
	[Serializable]
	public partial class LStandardTest : ActiveRecord<LStandardTest>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("L_Standard_Test", TableType.Table, DataService.GetInstance("ORM"));
				...
				TableSchema.TableColumn colvarDataName = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarDataPoint = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarDataView = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarDataPrint = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarReportDesc = new TableSchema.TableColumn(schema);
				colvarReportDesc.ColumnName = "ReportDesc";
				colvarReportDesc.DataType = DbType.String;
				colvarReportDesc.MaxLength = 20;
				colvarReportDesc.AutoIncrement = false;
				colvarReportDesc.IsNullable = true;
				colvarReportDesc.IsPrimaryKey = false;
				colvarReportDesc.IsForeignKey = false;
				colvarReportDesc.IsReadOnly = false;
				colvarReportDesc.DefaultSetting = @"";
				colvarReportDesc.ForeignKeyTableName = "";
				schema.Columns.Add(colvarReportDesc);
		...
		[XmlAttribute("ReportDesc")]
		[Bindable(true)]
		public string ReportDesc 
		{
			get { return GetColumnValue<string>(Columns.ReportDesc); }
			set { SetColumnValue(Columns.ReportDesc, value); }
		}
		...
		/// </summary>
		public static void Insert(string varTestDataId,int varTestTypeId,int? varDataSequence,string varDataName,string varMeasureUnit,short varDataPoint,string varNormalLevel,string varNormalLevelW,bool? varDataView,bool? varDataPrint,string varDescription,string varReportDesc)
		{
		...
		/// </summary>
		public static void Update(string varTestDataId,int varTestTypeId,int? varDataSequence,string varDataName,string varMeasureUnit,short varDataPoint,string varNormalLevel,string varNormalLevelW,bool? varDataView,bool? varDataPrint,string varDescription,string varReportDesc)
		{
			LStandardTest item = new LStandardTest();
        ...
        public static TableSchema.TableColumn ReportDescColumn
        {
		...
		public struct Columns
		{
			 ...
			 public static string ReportDesc = @"ReportDesc";
