...
namespace LIS.DAL
{
	...
	public partial class SysAdministrator : ActiveRecord<SysAdministrator>, IActiveRecord
	{
		...
		/// <summary>
		/// Returns a SysManagementUnit ActiveRecord object related to this SysAdministrator
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(string varPkSAdminID,string varFpSBranchID,string varPkSCreator,string varSPWD,int? varIMonth,int? varIYear,string varWebsite,byte[] varLogo)
		{
		...
		/// </summary>
		public static void Update(string varPkSAdminID,string varFpSBranchID,string varPkSCreator,string varSPWD,int? varIMonth,int? varIYear,string varWebsite,byte[] varLogo)
		{
			SysAdministrator item = new SysAdministrator();
