...
namespace LIS.DAL
{
	...
	public partial class SysManagementUnit : ActiveRecord<SysManagementUnit>, IActiveRecord
	{
		...
		public LIS.DAL.SysUserCollection SysUsers()
		{
			return new LIS.DAL.SysUserCollection().Where(SysUser.Columns.FpSBranchID, PkSBranchID).Load();
		}
		public LIS.DAL.SysAdministratorCollection SysAdministratorRecords()
		{
			return new LIS.DAL.SysAdministratorCollection().Where(SysAdministrator.Columns.FpSBranchID, PkSBranchID).Load();
		}
		public LIS.DAL.SysFunctionCollection SysFunctions()
		{
			return new LIS.DAL.SysFunctionCollection().Where(SysFunction.Columns.FpSBranchID, PkSBranchID).Load();
		}
		public LIS.DAL.SysRoleCollection SysRoles()
		{
			return new LIS.DAL.SysRoleCollection().Where(SysRole.Columns.FpSBranchID, PkSBranchID).Load();
		}
		public LIS.DAL.TblRolesForUserCollection TblRolesForUsers()
		{
			return new LIS.DAL.TblRolesForUserCollection().Where(TblRolesForUser.Columns.FpSBranchID, PkSBranchID).Load();
		}
		public LIS.DAL.SysSystemParameterCollection SysSystemParameters()
		{
			return new LIS.DAL.SysSystemParameterCollection().Where(SysSystemParameter.Columns.FpSBranchID, PkSBranchID).Load();
		}
		#endregion
		...
		public LIS.DAL.SysRoleCollection GetSysRoleCollection() { return SysManagementUnit.GetSysRoleCollection(this.PkSBranchID); }
		public static LIS.DAL.SysRoleCollection GetSysRoleCollection(string varPkSBranchID)
		{
		    SubSonic.QueryCommand cmd = new SubSonic.QueryCommand("SELECT * FROM [dbo].[Sys_Roles] INNER JOIN [tbl_RolesForUsers] ON [Sys_Roles].[FP_sBranchID] = [tbl_RolesForUsers].[FP_sBranchID] WHERE [tbl_RolesForUsers].[FP_sBranchID] = @FP_sBranchID", SysManagementUnit.Schema.Provider.Name);
		...
		public static void SaveSysRoleMap(string varPkSBranchID, SysRoleCollection items)
		{
			QueryCommandCollection coll = new SubSonic.QueryCommandCollection();
			//delete out the existing
			QueryCommand cmdDel = new QueryCommand("DELETE FROM [tbl_RolesForUsers] WHERE [tbl_RolesForUsers].[FP_sBranchID] = @FP_sBranchID", SysManagementUnit.Schema.Provider.Name);
		...
		public static void SaveSysRoleMap(string varPkSBranchID, System.Web.UI.WebControls.ListItemCollection itemList) 
		{
			QueryCommandCollection coll = new SubSonic.QueryCommandCollection();
			//delete out the existing
			 QueryCommand cmdDel = new QueryCommand("DELETE FROM [tbl_RolesForUsers] WHERE [tbl_RolesForUsers].[FP_sBranchID] = @FP_sBranchID", SysManagementUnit.Schema.Provider.Name);
		...
		public static void SaveSysRoleMap(string varPkSBranchID , long[] itemList) 
		{
			QueryCommandCollection coll = new SubSonic.QueryCommandCollection();
			//delete out the existing
			 QueryCommand cmdDel = new QueryCommand("DELETE FROM [tbl_RolesForUsers] WHERE [tbl_RolesForUsers].[FP_sBranchID] = @FP_sBranchID", SysManagementUnit.Schema.Provider.Name);
		...
		public static void DeleteSysRoleMap(string varPkSBranchID) 
		{
			QueryCommand cmdDel = new QueryCommand("DELETE FROM [tbl_RolesForUsers] WHERE [tbl_RolesForUsers].[FP_sBranchID] = @FP_sBranchID", SysManagementUnit.Schema.Provider.Name);
			cmdDel.AddParameter("@FP_sBranchID", varPkSBranchID, DbType.String);
		...
		public LIS.DAL.SysUserCollection GetSysUserCollection() { return SysManagementUnit.GetSysUserCollection(this.PkSBranchID); }
		public static LIS.DAL.SysUserCollection GetSysUserCollection(string varPkSBranchID)
		{
		    SubSonic.QueryCommand cmd = new SubSonic.QueryCommand("SELECT * FROM [dbo].[Sys_Users] INNER JOIN [tbl_RolesForUsers] ON [Sys_Users].[FP_sBranchID] = [tbl_RolesForUsers].[FP_sBranchID] WHERE [tbl_RolesForUsers].[FP_sBranchID] = @FP_sBranchID", SysManagementUnit.Schema.Provider.Name);
			cmd.AddParameter("@FP_sBranchID", varPkSBranchID, DbType.String);
			IDataReader rdr = SubSonic.DataService.GetReader(cmd);
		...
		public static void SaveSysUserMap(string varPkSBranchID, SysUserCollection items)
		{
			QueryCommandCollection coll = new SubSonic.QueryCommandCollection();
			//delete out the existing
			QueryCommand cmdDel = new QueryCommand("DELETE FROM [tbl_RolesForUsers] WHERE [tbl_RolesForUsers].[FP_sBranchID] = @FP_sBranchID", SysManagementUnit.Schema.Provider.Name);
		...
		public static void SaveSysUserMap(string varPkSBranchID, System.Web.UI.WebControls.ListItemCollection itemList) 
		{
			QueryCommandCollection coll = new SubSonic.QueryCommandCollection();
			//delete out the existing
			 QueryCommand cmdDel = new QueryCommand("DELETE FROM [tbl_RolesForUsers] WHERE [tbl_RolesForUsers].[FP_sBranchID] = @FP_sBranchID", SysManagementUnit.Schema.Provider.Name);
		...
		public static void SaveSysUserMap(string varPkSBranchID , string[] itemList) 
		{
			QueryCommandCollection coll = new SubSonic.QueryCommandCollection();
			//delete out the existing
			 QueryCommand cmdDel = new QueryCommand("DELETE FROM [tbl_RolesForUsers] WHERE [tbl_RolesForUsers].[FP_sBranchID] = @FP_sBranchID", SysManagementUnit.Schema.Provider.Name);
		...
		public static void DeleteSysUserMap(string varPkSBranchID) 
		{
			QueryCommand cmdDel = new QueryCommand("DELETE FROM [tbl_RolesForUsers] WHERE [tbl_RolesForUsers].[FP_sBranchID] = @FP_sBranchID", SysManagementUnit.Schema.Provider.Name);
			cmdDel.AddParameter("@FP_sBranchID", varPkSBranchID, DbType.String);
			DataService.ExecuteQuery(cmdDel);
