...
namespace LIS.DAL
{
	...
	public partial class SysReport : ActiveRecord<SysReport>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varMaBaocao,string varMaNhom,string varTieuDe,string varFileRieng,string varFileChuan,string varMoTa,string varNguoiTao,DateTime? varNgayTao,string varNguoiSua,DateTime? varNgaySua)
		{
		...
		/// </summary>
		public static void Update(string varMaBaocao,string varMaNhom,string varTieuDe,string varFileRieng,string varFileChuan,string varMoTa,string varNguoiTao,DateTime? varNgayTao,string varNguoiSua,DateTime? varNgaySua)
		{
			SysReport item = new SysReport();
