...
namespace LIS.DAL
{
	...
	public partial class SysTrinhky : ActiveRecord<SysTrinhky>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varReportName,string varObjectName,string varFontName,int? varFontSize,string varFontStype,string varObjectContent,string varTrinhky)
		{
		...
		/// </summary>
		public static void Update(string varReportName,string varObjectName,string varFontName,int? varFontSize,string varFontStype,string varObjectContent,string varTrinhky)
		{
			SysTrinhky item = new SysTrinhky();
