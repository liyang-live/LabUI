...
namespace LIS.DAL
{
    ...
    public partial class SysTrinhkyController
    {
	    ...
	    public void Insert(string ReportName,string ObjectName,string FontName,int? FontSize,string FontStype,string ObjectContent,string Trinhky)
	    {
	    ...
	    public void Update(string ReportName,string ObjectName,string FontName,int? FontSize,string FontStype,string ObjectContent,string Trinhky)
	    {
		    SysTrinhky item = new SysTrinhky();
	        item.MarkOld();
	        item.IsLoaded = true;
