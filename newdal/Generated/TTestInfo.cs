...
namespace LIS.DAL
{
	...
	/// </summary>
    [Serializable]
	public partial class TTestInfoCollection : ActiveList<TTestInfo, TTestInfoCollection>
	{	   
		public TTestInfoCollection() {}
	...
	/// </summary>
	[Serializable]
	public partial class TTestInfo : ActiveRecord<TTestInfo>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_TEST_INFO", TableType.Table, DataService.GetInstance("ORM"));
				...
				TableSchema.TableColumn colvarTestSeq = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarRequireDate = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarDiagnosticianId = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarTestStatus = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarDiagResult = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarLam = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarRegCount = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarRegNoResultCount = new TableSchema.TableColumn(schema);
		...
		/// </summary>
		public static void Insert(decimal? varTestTypeId,string varBarcode,string varTestSeq,decimal? varPatientId,DateTime? varTestDate,DateTime? varRequireDate,decimal? varAssignId,decimal? varDiagnosticianId,string varReceiverId,short? varTestStatus,string varDiagResult,string varUpdateUser,DateTime? varUpdateDate,string varLam,string varCanLamSangId,decimal? varDeviceId,int? varPrintStatus,int? varResultCount,int? varRegCount,int? varRegNoResultCount,int? varSentStatus)
		{
		...
		/// </summary>
		public static void Update(decimal varTestId,decimal? varTestTypeId,string varBarcode,string varTestSeq,decimal? varPatientId,DateTime? varTestDate,DateTime? varRequireDate,decimal? varAssignId,decimal? varDiagnosticianId,string varReceiverId,short? varTestStatus,string varDiagResult,string varUpdateUser,DateTime? varUpdateDate,string varLam,string varCanLamSangId,decimal? varDeviceId,int? varPrintStatus,int? varResultCount,int? varRegCount,int? varRegNoResultCount,int? varSentStatus)
		{
			TTestInfo item = new TTestInfo();
