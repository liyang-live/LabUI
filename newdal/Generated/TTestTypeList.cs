...
namespace LIS.DAL
{
	...
	/// </summary>
    [Serializable]
	public partial class TTestTypeListCollection : ActiveList<TTestTypeList, TTestTypeListCollection>
	{	   
		public TTestTypeListCollection() {}
	...
	/// </summary>
	[Serializable]
	public partial class TTestTypeList : ActiveRecord<TTestTypeList>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_TEST_TYPE_LIST", TableType.Table, DataService.GetInstance("ORM"));
				...
				TableSchema.TableColumn colvarPrintDetail = new TableSchema.TableColumn(schema);
		...
		/// </summary>
		public static void Insert(string varTestTypeName,string varNote,short? varIntOrder,short? varPrintDetail,decimal? varPrice,string varAbbreviation)
		{
		...
		/// </summary>
		public static void Update(int varTestTypeId,string varTestTypeName,string varNote,short? varIntOrder,short? varPrintDetail,decimal? varPrice,string varAbbreviation)
		{
			TTestTypeList item = new TTestTypeList();
