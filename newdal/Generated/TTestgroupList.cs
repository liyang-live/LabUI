...
namespace LIS.DAL
{
	...
	/// </summary>
    [Serializable]
	public partial class TTestgroupListCollection : ActiveList<TTestgroupList, TTestgroupListCollection>
	{	   
		public TTestgroupListCollection() {}
	...
	/// </summary>
	[Serializable]
	public partial class TTestgroupList : ActiveRecord<TTestgroupList>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("T_TESTGROUP_LIST", TableType.Table, DataService.GetInstance("ORM"));
				...
				TableSchema.TableColumn colvarTestGroupName = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarTestGroupOrder = new TableSchema.TableColumn(schema);
		...
		/// </summary>
		public static void Insert(string varTestGroupName,string varDescription,decimal? varDeviceId,int? varTestTypeId,short? varTestGroupOrder)
		{
		...
		/// </summary>
		public static void Update(int varTestGroupId,string varTestGroupName,string varDescription,decimal? varDeviceId,int? varTestTypeId,short? varTestGroupOrder)
		{
			TTestgroupList item = new TTestgroupList();
