...
namespace LIS.DAL
{
	...
	/// </summary>
    [Serializable]
	public partial class TblHisLisPatientInfoVnioCollection : ActiveList<TblHisLisPatientInfoVnio, TblHisLisPatientInfoVnioCollection>
	{	   
		public TblHisLisPatientInfoVnioCollection() {}
	...
	/// </summary>
	[Serializable]
	public partial class TblHisLisPatientInfoVnio : ActiveRecord<TblHisLisPatientInfoVnio>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("tblHisLis_PatientInfo_VNIO", TableType.Table, DataService.GetInstance("ORM"));
				...
				TableSchema.TableColumn colvarBacSyDieuTri = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarIdBacSyDieuTri = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarDichVu = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarIdDoiTuongBenhNhan = new TableSchema.TableColumn(schema);
		...
		/// </summary>
		public static void Insert(string varBacSyDieuTri,string varBuong,string varDiaChi,bool? varGioiTinh,string varGiuong,string varIdBacSyDieuTri,short? varIdKhoa,string varKhoa,string varMaBenhNhan,bool? varNoiTru,string varPhong,string varTenBenhNhan,short? varTuoi,string varSophieu,DateTime? varTestDate,string varDatra,bool? varDichVu,int? varIdDoiTuongBenhNhan,string varMaLanKham)
		{
		...
		/// </summary>
		public static void Update(long varId,string varBacSyDieuTri,string varBuong,string varDiaChi,bool? varGioiTinh,string varGiuong,string varIdBacSyDieuTri,short? varIdKhoa,string varKhoa,string varMaBenhNhan,bool? varNoiTru,string varPhong,string varTenBenhNhan,short? varTuoi,string varSophieu,DateTime? varTestDate,string varDatra,bool? varDichVu,int? varIdDoiTuongBenhNhan,string varMaLanKham)
		{
			TblHisLisPatientInfoVnio item = new TblHisLisPatientInfoVnio();
