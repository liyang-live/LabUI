...
namespace LIS.DAL
{
	...
	/// </summary>
    [Serializable]
	public partial class TblPaymentCollection : ActiveList<TblPayment, TblPaymentCollection>
	{	   
		public TblPaymentCollection() {}
	...
	/// </summary>
	[Serializable]
	public partial class TblPayment : ActiveRecord<TblPayment>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("tbl_Payment", TableType.Table, DataService.GetInstance("ORM"));
				...
				TableSchema.TableColumn colvarSUser = new TableSchema.TableColumn(schema);
		...
		/// </summary>
		public static void Insert(long? varPatientID,long? varRegID,DateTime? varPaymentDate,decimal? varTotalPayment,short? varReasonID,string varSUser,string varSDesc)
		{
		...
		/// </summary>
		public static void Update(long varPaymentID,long? varPatientID,long? varRegID,DateTime? varPaymentDate,decimal? varTotalPayment,short? varReasonID,string varSUser,string varSDesc)
		{
			TblPayment item = new TblPayment();
