...
namespace LIS.DAL
{
	...
	/// </summary>
    [Serializable]
	public partial class TblReasonCollection : ActiveList<TblReason, TblReasonCollection>
	{	   
		public TblReasonCollection() {}
	...
	/// </summary>
	[Serializable]
	public partial class TblReason : ActiveRecord<TblReason>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("tbl_Reason", TableType.Table, DataService.GetInstance("ORM"));
