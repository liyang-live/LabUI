...
namespace LIS.DAL
{
	...
	/// </summary>
    [Serializable]
	public partial class TblRegServiceCollection : ActiveList<TblRegService, TblRegServiceCollection>
	{	   
		public TblRegServiceCollection() {}
	...
	/// </summary>
	[Serializable]
	public partial class TblRegService : ActiveRecord<TblRegService>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("tbl_RegService", TableType.Table, DataService.GetInstance("ORM"));
				...
				TableSchema.TableColumn colvarRegNo = new TableSchema.TableColumn(schema);
				...
				TableSchema.TableColumn colvarRegType = new TableSchema.TableColumn(schema);
		...
		/// </summary>
		public static void Insert(long varPatientID,DateTime varTestDate,string varRegNo,short varServiceType,short varRegType,short? varNTime,decimal? varTotalMoney,string varSDesc)
		{
		...
		/// </summary>
		public static void Update(long varRegID,long varPatientID,DateTime varTestDate,string varRegNo,short varServiceType,short varRegType,short? varNTime,decimal? varTotalMoney,string varSDesc)
		{
			TblRegService item = new TblRegService();
