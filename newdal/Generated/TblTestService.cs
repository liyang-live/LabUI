...
namespace LIS.DAL
{
	...
	/// </summary>
    [Serializable]
	public partial class TblTestServiceCollection : ActiveList<TblTestService, TblTestServiceCollection>
	{	   
		public TblTestServiceCollection() {}
	...
	/// </summary>
	[Serializable]
	public partial class TblTestService : ActiveRecord<TblTestService>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("tbl_TestService", TableType.Table, DataService.GetInstance("ORM"));
